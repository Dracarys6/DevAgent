...
from devagent.tools.knowledge_tools import KnowledgeRetrieveError, knowledge_retrieve

router = APIRouter(prefix="/api/v1/knowledge", tags=["knowledge"])


@router.post("/search", response_model=RetrievalResult)
def search_workspace_knowledge(request: KnowledgeSearchRequest) -> RetrievalResult:
