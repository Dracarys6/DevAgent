    ...
    return "\n".join(
        [
            ...
            *business_rows,
            ...
            "## Failure Analysis",
            "",
            f"- Failed tool cases: {_render_values(quality.failed_tool_case_ids)}",
            f"- Missed evidence cases: {_render_values(quality.missed_evidence_case_ids)}",
            f"- Missing answer keywords: {_render_values(quality.missing_answer_keywords)}",
            f"- Incorrect non-empty negative cases: {_render_values(quality.incorrect_non_empty_case_ids)}",
            "",
