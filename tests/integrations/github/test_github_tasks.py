...
def test_task_manager_does_not_repeat_terminal_task(tmp_path: Path) -> None:
    ...
    task = manager.create_task(delivery_id="delivery-1", locator=make_locator())
...
def test_task_manager_failure_is_sanitized_and_releases_delivery(
    ...
    retry = manager.create_task(delivery_id="delivery-1", locator=make_locator())
...
def test_task_manager_rejects_duplicate_delivery_and_unknown_task(
    ...
    manager.create_task(delivery_id="delivery-1", locator=make_locator())
